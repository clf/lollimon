...
\item If $\CLFRIseq{\Gamma}{\cdot}{A}$ and $\CLFLFseq{\Gamma, A}{\Delta}{B}{P}$ then $\CLFLFseq{\Gamma}{\Delta}{B}{P}$ when $A \neq B$.
...
\item If $\CLFRIseq{\Gamma}{\cdot}{A}$ and $\CLFLLFseq{\Gamma, A}{\Delta}{B}{S}$ then $\CLFLLFseq{\Gamma}{\Delta}{B}{S}$ when $A \neq B$.
...
\\
\item If $\CLFRIseq{\Gamma}{\cdot}{A}$ and $\CLFLIseq{\Gamma, A}{\Delta}{S}{T}$ then $\CLFLIseq{\Gamma}{\Delta}{S}{T}$.
\item If $\CLFRIseq{\Gamma}{\Delta_1}{A}$ and $\CLFLIseq{\Gamma}{\Delta_2, A}{S}{T}$ then $\CLFLIseq{\Gamma}{\Delta_1, \Delta_2}{S}{T}$.
\\
...
\item If $\CLFRFseq{\Gamma}{\Delta_1}{S'}$ and $\CLFLIseq{\Gamma}{\Delta_2}{S'}{S}$ then $\CLFLseq{\Gamma}{\Delta_2}{S}$.
\item If $\CLFRFseq{\Gamma}{\Delta_1}{S'}$ and $\CLFLIseq{\Gamma}{\Delta_2}{S',\Psi}{S}$ then $\CLFLIseq{\Gamma}{\Delta_2}{\Psi}{S}$.
\end{enumerate}
\end{Teorema}

\begin{Demo}
By structural induction on the cut formula and then the second given derivation.
\end{Demo}
